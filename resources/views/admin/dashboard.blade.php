            ...
            <div class="col-md-5 hidden-xs">
                <div class="logo">
                    <a href="/">
                        ...
                        <span class="logo-full">Dashboard</span>
                    </a>
                </div>
                ...
                <ul>
                    ...
                    <li class="btn-group user-account">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <li><a href="{{ route('admin.logout')}}" class="animsition-link dropdown-item wave-effect"><i class="feather icon-log-in"></i> Logout</a></li>
                        </ul>
                    </li>
                    <!-- Offcanvas Menu -->
                    <li>
...
<!-- partial -->
  <script  src="{{asset('js/admin/dashboardscript.js' )}}"></script>
